...
public class AdwordsMultiCampaignOutput {
    ...
    public static void runMe(AdwordsConfig config, String outputFolderName, int workTokenSize) throws IOException {
        ...
        String tempFolder = FilePathUtils.getFolderPath(config.getDataFolderPath(),
                AdwordsConstants.DEFAULT_TEMP_SUB_FOLDER);
        ...
        File[] listOfFiles = FileUtilsPralav.getListOfFiles(tempFolder);
